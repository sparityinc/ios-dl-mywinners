...
{
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"MyWinners" message:Mess delegate:self cancelButtonTitle:@"OK" otherButtonTitles:@"Cancel", nil];//The End of Tutorial
    [alert show];
}
