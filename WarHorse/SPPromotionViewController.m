...
- (void)viewDidLoad
{
    ...
    UILabel *promotionLabel = [[UILabel alloc]initWithFrame:CGRectMake(44, 36, 100, 12)];
    [promotionLabel setBackgroundColor:[UIColor clearColor]];
    [promotionLabel setText:@"Promotions"];
    [promotionLabel setFont:[UIFont fontWithName:@"Roboto-Light" size:15]];
    [promotionLabel setTextColor:[UIColor whiteColor]];
