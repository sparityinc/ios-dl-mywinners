    ...
    if (![[[WarHorseSingleton sharedInstance] isAdwEnable] isEqualToString:@"false"]){
        ...
        switch (sender.tag) {
            case 1:
            {
                ...
                UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"Secure Registration" message:@"Do you already have an account with mywinners account?" delegate:self cancelButtonTitle:@"NO" otherButtonTitles:@"YES", nil];
                [alertView show];
