...
- (void) pushToView:(DashBoard)viewNumber
{
    switch (viewNumber)
    {
        ...
        case DashBoardVideoReplay:
            ...
            break;
        case DashBoard123LeaderBoard:
            [self load123LeadBoardScreen];
            break;
...
-(void)load123LeadBoardScreen{
     SPLeaderBoardViewController*leaderBoardViewCntr = [[SPLeaderBoardViewController alloc] initWithNibName:@"SPLeaderBoardViewController" bundle:nil];
    leaderBoardViewCntr.leadersboard_URL = self.leadersboard_URL;
    
    ZLLeftSideMenuViewController *wagerLeftViewController=[[ZLLeftSideMenuViewController alloc]init];
    UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:leaderBoardViewCntr];
    RevealController *revealController = [[RevealController alloc] initWithFrontViewController:navigationController rearViewController:wagerLeftViewController];
    self.viewController = revealController;
...
- (void)loadData
{
    ...
    if ([[[WarHorseSingleton sharedInstance] isOntEnable] isEqualToString:@"true"]){
        ...
        [dic1 setObject:[UIColor colorWithRed:242.0/255 green:174.0/255 blue:28.0/255 alpha:1.0] forKey:@"backgroundColor"];
        [self.numberArray addObject:dic1];
        }
        
    }else{
        NSMutableDictionary *dic1 = [NSMutableDictionary dictionary];
        [dic1 setValue:@"Live Videos" forKey:@"title"];
        [dic1 setValue:@"video-replay.png" forKey:@"icon"];
        [dic1 setValue:@"4" forKey:@"badgeNumber"];
        [dic1 setObject:[UIColor colorWithRed:242.0/255 green:174.0/255 blue:28.0/255 alpha:1.0] forKey:@"backgroundColor"];
        [self.numberArray addObject:dic1];
    }
    ...
    if ([[WarHorseSingleton sharedInstance]is123BetsEnable] == YES)
    {
    NSMutableDictionary *tabledic2 = [NSMutableDictionary dictionary];
    [tabledic2 setValue:@"123 LeaderBoard" forKey:@"title"];
    [tabledic2 setValue:@"leaderboard_icon.png" forKey:@"iconImages"];
    ...
    //    NSMutableDictionary *tabledic2 = [NSMutableDictionary dictionary];
    //    [tabledic2 setValue:@"Alerts" forKey:@"title"];
    //    [tabledic2 setValue:@"dashboardalertsicon.png" forKey:@"iconImages"];
    //    [self.tableArray addObject:tabledic2];
    ...
    //    NSMutableDictionary *tabledic2 = [NSMutableDictionary dictionary];
    //    [tabledic2 setValue:@"QRCode" forKey:@"title"];
    ...
    [tabledic7 setValue:@"SCR & Changes" forKey:@"title"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)cv cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.numberArray count]>0) {
        ...
        if ([cell.titleLabel.text isEqualToString:@"Wallet"])
        {
            ...
            [cell.badgeButton setTitle:[NSString stringWithFormat:@"Balance: $%.2f", [ZLAppDelegate getAppData].balanceAmount] forState:UIControlStateNormal];
        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([typeOfScreen isEqualToString:@"123 LeaderBoard"]){
        [self pushToView:DashBoard123LeaderBoard];
    }
    
   else if ([typeOfScreen isEqualToString:@"Live Videos/Replays"]){
        [self pushToView:DashBoardVideoReplay];
    ...
    }else if ([typeOfScreen isEqualToString:@"SCR & Changes"]){
