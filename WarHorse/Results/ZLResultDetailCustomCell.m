...
- (void)updateViewAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0 && [self.trackResult.winnersByPosition count] > 0 ) {
        ...
        if( finisher){
            ...
            if( finisher.shwPayOff != nil && finisher.shwPayOff.length > 0){
                ...
                if( payOff > 0.0)
                    [betType_label setText:[NSString stringWithFormat:@"$%@",finisher.shwPayOff]];
            ...
            if( finisher.plcPayOff != nil && finisher.plcPayOff.length > 0){
                ZLCustomUILabel *betType_label=[[ZLCustomUILabel alloc] init];
                [betType_label setFrame:CGRectMake(i, j, 44, 20)];
                [betType_label setFont:[UIFont fontWithName:@"Roboto-Medium" size:13]];
                [betType_label setTextColor:[UIColor colorWithRed:30.0/255.0f green:30.0/255.0f blue:30.0/255.0f alpha:1.0]];
                ...
                if( payOff > 0.0)
                    [betType_label setText:[NSString stringWithFormat:@"$%@",finisher.plcPayOff]];
                [self.contentView addSubview:betType_label];
                i -= 49;
            }
            ...
            if( finisher.winPayOff != nil && finisher.winPayOff.length > 0){
                ZLCustomUILabel *betType_label=[[ZLCustomUILabel alloc] init];
                [betType_label setFrame:CGRectMake(i, j, 44, 20)];
                [betType_label setFont:[UIFont fontWithName:@"Roboto-Medium" size:13]];
                [betType_label setTextColor:[UIColor colorWithRed:30.0/255.0f green:30.0/255.0f blue:30.0/255.0f alpha:1.0]];
                ...
                if( payOff > 0.0)
                    [betType_label setText:[NSString stringWithFormat:@"$%@",finisher.winPayOff]];
                [self.contentView addSubview:betType_label];
                i -= 49;
            }
        ...
        if(betResultRunner != nil){
            ...
            self.titleLabel.text = [NSString stringWithFormat:@"$%@ %@", @"2", betResultRunner.betCode]; //Fix needed
            [self.titleLabel setTextColor:[UIColor colorWithRed:30.0/255.0f green:30.0/255.0f blue:30.0/255.0f alpha:1.0]];
            [self.titleLabel setFont:[UIFont fontWithName:@"Roboto-Medium" size:12]];
            ...
            if( payOff != 0.0)
                [self.accessoryLabel setText:[NSString stringWithFormat:@"$%@", betResultRunner.amount]];
    ...
    else if (indexPath.section == 2)
    {
        ...
        ZLFinisher * scratcher = [trackResult.scratches objectAtIndex:indexPath.row];
        if( !scratcher ){
            [self.titleLabel setFrame:CGRectMake(6, 2.5, 255, 20)];
            self.titleLabel.text = [NSString stringWithFormat:@"%d",scratcher.runnerPosition];//scratcher.horseName;
            [self.titleLabel setFont:[UIFont fontWithName:@"Roboto-Medium" size:12]];
