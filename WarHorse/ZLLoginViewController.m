...
- (IBAction)segmentedBtn:(id)sender
{
    ...
    if ([[self.segmentedView titleForSegmentAtIndex:self.segmentedView.selectedSegmentIndex] isEqualToString:@"MyWinners"]){
        ...
        [[NSUserDefaults standardUserDefaults] setObject:@"MyWinnersCT-ODP" forKey:@"ClientId"];
        [[NSUserDefaults standardUserDefaults] synchronize];
    }
        ...
        [[NSUserDefaults standardUserDefaults] setObject:@"MyWinnersCT-DV" forKey:@"ClientId"];
        [[NSUserDefaults standardUserDefaults] synchronize];
...
- (void)dashBoardView
{
    ...
    mainGridViewController.leadersboard_URL = self.leadersboard_URL;
