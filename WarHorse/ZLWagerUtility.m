...
+(void) initialize{
    ...
    betTypeMappings = @{@"WIN":@"WIN",@"PLC":@"PLC",@"SHW":@"SHW",@"WP":@"WP",@"WPS":@"WPS",@"WS":@"WS",@"PS":@"PS",@"EXA":@"EXA",@"EBX":@"EBX",@"QNL":@"QNL",@"QBX":@"QBX",@"TRI":@"TRI",@"TBX":@"TBX",@"DBL":@"DBL",@"PK3":@"PK3",@"PK4":@"PK4",@"PK5":@"PK5",@"PK6":@"PK6",@"PK7":@"PK7",@"PK8":@"PK8",@"PK9":@"PK9",@"PK10":@"P10",@"PK11":@"P11",@"PK12":@"P12",@"PK13":@"P13",@"PK14":@"P14",@"PK15":@"P15",@"PK16":@"P16",@"TQN":@"TQN",@"TQX":@"TQX",@"DQL":@"DQL",@"DQX":@"DQX",@"DEX1":@"DEX_1",@"DEX2":@"DEX_2",@"CH6":@"CH_6",@"E5N":@"E_5_N",@"E5B":@"E_5_B",@"P10":@"P10"};
...
+(int) getNumCombos:(ZLWager*) _wager{
    ...
    int legs_count = [_wager.selectedRunners count];
    ...
    else if( [_wager.selectedBetType isEqualToString:(@"WS")] || [_wager.selectedBetType isEqualToString:(@"PS")] ||[_wager.selectedBetType isEqualToString:(@"WP")] ){
    ...
    else if( [_wager.selectedBetType isEqualToString:(@"DBL")] || [_wager.selectedBetType isEqualToString:(@"PK3")] || [_wager.selectedBetType isEqualToString:(@"PK4")] || [_wager.selectedBetType isEqualToString:(@"PK5")] || [_wager.selectedBetType isEqualToString:(@"PK6")] || [_wager.selectedBetType isEqualToString:(@"PK7")] || [_wager.selectedBetType isEqualToString:(@"PK8")] || [_wager.selectedBetType isEqualToString:(@"PK9")] || [_wager.selectedBetType isEqualToString:(@"P10")] || [_wager.selectedBetType isEqualToString:(@"123")] )
    {
        int idx = [ZLWagerUtility getBetId:_wager.selectedBetType];
        if ( numLegs == [[num_leg_map objectAtIndex:idx ] intValue] ){
