...
- (void)viewDidLoad
{
    ...
    UILabel *selectionsText = [[UILabel alloc]initWithFrame:CGRectMake(44, 35  , 300, 19)];
    [selectionsText setBackgroundColor:[UIColor clearColor]];
    [selectionsText setText:@"Feature Races"];
    [selectionsText setFont:[UIFont fontWithName:@"Roboto-Light" size:16]];
    [selectionsText setTextColor:[UIColor whiteColor]];
