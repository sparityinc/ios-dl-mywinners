...
@property (nonatomic, assign) BOOL is123LeaderBoardEnable;
...
- (void)viewDidLoad
{
   ...
   // self.is123LeaderBoardEnable = YES;
...
- (void)loadData
{
    ...
    [dic setValue:@"Today's Tracks" forKey:@"title"];
    ...
    [dic2 setValue:@"Carryovers" forKey:@"title"];
    ...
    [dic4 setValue:@"Selections" forKey:@"title"];//Help/Support
    [dic4 setValue:@"selections.png" forKey:@"icon"];//help&support.png
    ...
    if(self.is123LeaderBoardEnable == YES)
        
    {
        NSMutableDictionary *tabledic1 = [NSMutableDictionary dictionary];
        [tabledic1 setValue:@"123 LeaderBoard" forKey:@"title"];
        [tabledic1 setValue:@"leaderboard_icon.png" forKey:@"iconImages"];
    ...
    [tabledic2 setValue:@"Rewards Structure" forKey:@"title"];
    [tabledic2 setValue:@"rewardstructure.png" forKey:@"iconImages"];
    [self.tableArray addObject:tabledic2];
    }
    
    NSMutableDictionary *tabledic3 = [NSMutableDictionary dictionary];
    [tabledic3 setValue:@"Help/Support" forKey:@"title"];//Selections
    [tabledic3 setValue:@"help&support.png" forKey:@"iconImages"];//selections.png
    [self.tableArray addObject:tabledic3];
    
    NSMutableDictionary *tabledic4 = [NSMutableDictionary dictionary];
    [tabledic4 setValue:@"Tutorial" forKey:@"title"];//Feature Races
    [tabledic4 setValue:@"getstarted.png" forKey:@"iconImages"];//featureraces.png
    ...
    [tabledic5 setValue:@"About MyWinners" forKey:@"title"];
    [tabledic5 setValue:@"aboutdigitallink.png" forKey:@"iconImages"];
...
- (void)collectionData
{
    ...
    {
        NSMutableDictionary *tabledic1 = [NSMutableDictionary dictionary];
        [tabledic1 setValue:@"123 LeaderBoards" forKey:@"title"];
        [tabledic1 setValue:@"leaderboard_icon.png" forKey:@"iconImages"];
        [self.tableArray addObject:tabledic1];
    ...
    NSMutableDictionary *tabledic5 = [NSMutableDictionary dictionary];
    [tabledic5 setValue:@"About MypWinners" forKey:@"title"];
    [tabledic5 setValue:@"aboutdigitallink.png" forKey:@"iconImages"];
    [self.tableArray addObject:tabledic5];
...
- (void)appConfigCMSService
{
    ...
    [apiWrapper getAppConfigurationForClientID:nil success:^(NSDictionary *appDetails){
        ...
        if ([succesMesStr isEqualToString:@"success"]){
            ...
            self.leadersboard_URL = [[[[appDetails valueForKey:@"response-content"] objectAtIndex:0]valueForKey:@"AppFeatureConfig"] valueForKey:@"123_leadersboard_URL"];
            
           self.is123LeaderBoardEnable = [[[[[appDetails valueForKey:@"response-content"] objectAtIndex:0]valueForKey:@"AppFeatureConfig"] valueForKey:@"is_123_leadersboard_enabled"] boolValue];
            ...
            [[WarHorseSingleton sharedInstance] setIs123BetsEnable:self.is123LeaderBoardEnable];
          ...
          [[WarHorseSingleton sharedInstance] setIs_nick_name_enabled:[[[[[appDetails valueForKey:@"response-content"] objectAtIndex:0]valueForKey:@"AppFeatureConfig"] valueForKey:@"is_nick_name_enabled"] boolValue]];
            
             [[WarHorseSingleton sharedInstance] setNick_name_label:[[[[appDetails valueForKey:@"response-content"] objectAtIndex:0]valueForKey:@"AppFeatureConfig"] valueForKey:@"nick_name_label"]];
...
-(IBAction)loginClicked:(id)sender
{
    ...
    loginViewController.leadersboard_URL = self.leadersboard_URL;
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ((self.isFetureRacesEnable == NO) && (self.isPromotionsEnable == NO))
    {
     ...
     //   [self.staticLineImg setFrame:CGRectMake(self.staticLineImg.frame.origin.x, self.staticLineImg.frame.origin.y-5, self.staticLineImg.frame.size.width, self.staticLineImg.frame.size.height)
        // ];
        ...
        [self.tableView setFrame:CGRectMake(self.collectionView.frame.origin.x, self.collectionView.frame.origin.y+40, self.tableView.frame.size.width,self.tableView.frame.size.height)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.isRewordAvailable == YES && [[WarHorseSingleton sharedInstance] is123BetsEnable] == YES){
        
        if (indexPath.row == 0)
        {
            SP123LeaderBoardViewController *leaderBoards = [[SP123LeaderBoardViewController alloc]initWithNibName:@"SP123LeaderBoardViewController" bundle:nil];
            leaderBoards.leadersboard_URL = self.leadersboard_URL;
            [self.navigationController pushViewController:leaderBoards animated:YES];        }
    ...
    else if (self.isRewordAvailable == YES && [[WarHorseSingleton sharedInstance] is123BetsEnable] == NO)
    {
        if (indexPath.row == 0)
        {
            SPRewardsDetailViewController *rewards = [[SPRewardsDetailViewController alloc] initWithNibName:@"SPRewardsDetailViewController" bundle:nil];
    ...
    else if ([[WarHorseSingleton sharedInstance] is123BetsEnable] == YES && self.isRewordAvailable == YES ){
        if (indexPath.row == 0)
        {
            SP123LeaderBoardViewController *leaderBoards = [[SP123LeaderBoardViewController alloc]initWithNibName:@"SP123LeaderBoardViewController" bundle:nil];
            leaderBoards.leadersboard_URL = self.leadersboard_URL;
...
/*    switch (indexPath.row) {
        ...
        case 1:
        {
            ...
            /*
             SPDetailSelectionViewController *detailSelection = [[SPDetailSelectionViewController alloc] initWithNibName:@"SPDetailSelectionViewController" bundle:nil];
