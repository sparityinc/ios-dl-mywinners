...
- (void)viewDidLoad
{
    ...
    //    [dic11 setObject:[UIImage imageNamed:@"alertsicon.png"] forKey:@"logo"];
    ...
    [dic9 setValue:@"123 LeaderBoard" forKey:@"title"];
    [dic9 setObject:[UIImage imageNamed:@"leaderboard_icon_grey.png"] forKey:@"logo"];
    [dic9 setObject:[NSNumber numberWithInt:DashBoard123LeaderBoard] forKey:@"enumValue"];
    ...
    [dic6 setValue:@"SCR & Changes" forKey:@"title"];
